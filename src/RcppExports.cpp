...
RcppExport SEXP _knapsack2_rcpp_hello_world() {
BEGIN_RCPP
...
RcppExport SEXP _knapsack2_rcpp_sac_a_dos(SEXP poidsSEXP, SEXP valeursSEXP, SEXP poids_maxSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _knapsack2_rcpp_sac_a_dos_dp(SEXP poidsSEXP, SEXP valeursSEXP, SEXP poids_maxSEXP, SEXP precisionSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< NumericVector >::type poids(poidsSEXP);
...
RcppExport SEXP _knapsack2_rcpp_sac_a_dos_glouton(SEXP poidsSEXP, SEXP valeursSEXP, SEXP poids_maxSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< NumericVector >::type poids(poidsSEXP);
...
static const R_CallMethodDef CallEntries[] = {
    {"_knapsack2_rcpp_hello_world", (DL_FUNC) &_knapsack2_rcpp_hello_world, 0},
    {"_knapsack2_rcpp_sac_a_dos", (DL_FUNC) &_knapsack2_rcpp_sac_a_dos, 3},
    {"_knapsack2_rcpp_sac_a_dos_dp", (DL_FUNC) &_knapsack2_rcpp_sac_a_dos_dp, 4},
    {"_knapsack2_rcpp_sac_a_dos_glouton", (DL_FUNC) &_knapsack2_rcpp_sac_a_dos_glouton, 3},
    {NULL, NULL, 0}
};

RcppExport void R_init_knapsack2(DllInfo *dll) {
